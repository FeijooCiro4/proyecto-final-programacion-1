...
* Commit y despliegue al repositorio remoto.
### Viernes 27/06/2025
* Se ha realizado el cambio sugerido con respecto a la eliminación del rol comprador, y sustituirlo por un usuario queneral que no ingresa sus datos para acceder, sin embargo este usuario solo accede a los autos que stán a la venta, viendo solo el nombre y el número de teléfono del respectivo vendedor.
* Se ha hecho un cambio de diseño en la organización del proyecto, utilizando las carpetas `Model`, `View` y `Controller` para organizar el proyecto.
* Commit y despliegue al repositorio remoto.
